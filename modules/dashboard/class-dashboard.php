...
final class HMN_CRM_Dashboard {
	...
	public static function render_portal() {
		...
		// Query-based route avoids host/cache rewrite 404 errors in calendar links.
		$base = add_query_arg( 'hmn_crm_portal', '1', home_url( '/' ) );
		?>
<!doctype html>
